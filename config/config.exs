...
config :artist_discovery,
  ecto_repos: [ArtistDiscovery.Repo]

# Configures the endpoint
config :artist_discovery, ArtistDiscoveryWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: ArtistDiscoveryWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: ArtistDiscovery.PubSub,
  live_view: [signing_salt: "/I9r/oXD"]
